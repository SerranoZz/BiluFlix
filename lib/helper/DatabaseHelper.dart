  ...
  Future<Database> initDb() async {
    ...
    Database db = await openDatabase(
      ...
      onCreate: (db, version) async {
        ...
        sql = """INSERT INTO video(userid, name, description, type, ageRestriction, durationMinutes, thumbnailImageId, releaseDate)VALUES(${0},"Black Mirror", "Contos de ficção científica que refletem o lado negro das telas e da tecnologia, mostrando que nem toda novidade traz só benefícios.", 1, "18", "6 temporadas", "https://img.olhardigital.com.br/wp-content/uploads/2023/06/Black-Mirror.png", "4 de dezembro de 2011");""";
        await db.execute(sql);
        ...
        sql = """INSERT INTO video(userid, name, description, type, ageRestriction, durationMinutes, thumbnailImageId, releaseDate)VALUES(${0},"She-Hulk", "Jennifer Walters tem uma vida complicada, pois além de advogada, solteira de 30 e poucos anos, é também um hulk superpoderoso.", 1, "14", "1 temporada", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfytHTFyc0YUzgkn6EYA_u9at5FazZFZfzJiSOzeFACbrpPyIA", "18 de agosto de 2022");""";
        await db.execute(sql);

        sql = """INSERT INTO video(userid, name, description, type, ageRestriction, durationMinutes, thumbnailImageId, releaseDate)VALUES(${0},"The Flash", "Acompanhe as aventuras do homem mais veloz do planeta, o cientista da Central City Police Barry Allen, que após um trágico acidente adquire o poder da velocidade.", 1, "13", "9 temporadas", "https://m.media-amazon.com/images/M/MV5BZDcwMzU4NWYtODIzZi00Yzg4LWJhOTAtOTQ2ZDA4NmFlYmFlXkEyXkFqcGdeQXVyMTY1MTU3NDY5._V1_FMjpg_UX1000_.jpg", "7 de outubro de 2014");""";
        await db.execute(sql);
        ...
        sql = """INSERT INTO video(userid, name, description, type, ageRestriction, durationMinutes, thumbnailImageId, releaseDate)VALUES(${0},"Arcane", "Em meio ao conflito entre as cidades-gêmeas de Piltover e Zaun, duas irmãs lutam em lados opostos de uma guerra entre tecnologias mágicas e convicções incompatíveis.", 1, "14", "1 temporada", "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQw9ZZQVJqnze9k8r6c5xUeFSc9iBNtiY2nuQd_N1qWAQ6javhR", "6 de novembro de 2021");""";
        await db.execute(sql);
